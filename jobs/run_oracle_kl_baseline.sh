#!/bin/bash
#SBATCH --job-name=oracle-kl-cg
#SBATCH --output=logs/oracle_kl_baseline_%j.out
#SBATCH --error=logs/oracle_kl_baseline_%j.err
...
python scripts/eval_oracle_kl_baseline.py \
    ...
    --seed 123 \
    --recompute-kl \
    --oracle-output-csv outputs/oracle_kl_module_ranking.csv \
    --output-csv outputs/oracle_kl_vs_causalgate.csv
